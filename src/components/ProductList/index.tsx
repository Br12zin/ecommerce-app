  ...
  return(
    <View>
      ...
      style={styles.list}
        ...
        renderItem={({ item }) => <ProductItem id={item.id_produto.toString()} name={item.produto} price={item.preco} imagem={item.imagem} />} // para renderizar cada item da lista, passando o nome da categoria como props para o componente CategoryItem
      />
    </View>
  )
}